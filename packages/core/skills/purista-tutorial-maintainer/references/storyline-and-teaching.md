...
| --- | --- | --- | --- | --- | --- |
| `answerTransactionQuestion` | `npm run add:agent ...` | agent schemas, prompt, and instructions | `supportHarness.addAgent(...)` and `.mountHarness(...)` | `ai.model` | standalone Harness and EventBridge tests |

...
- Completed tutorials become visible after the strong local tutorial verifier;
  registry-backed replay is tracked separately and does not keep completed work
  in draft

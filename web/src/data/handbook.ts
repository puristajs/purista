		...
		cards: [
			{
				...
				items: [
					...
					{ id: 'harness/guide/models-and-configuration', title: 'Models & Configuration', order: 3 },
					{ id: 'harness/guide/tools-and-skills', title: 'Tools & Skills', order: 4 },
					{ id: 'harness/guide/sandboxing-and-mcp', title: 'Sandboxing & MCP', order: 5 },
					{ id: 'harness/guide/agents-workflows-state', title: 'Agents, Workflows & State', order: 6 },
					{ id: 'harness/guide/durable-workflows-and-queues', title: 'Durable Workflows & Queues', order: 7 },
					{ id: 'harness/guide/guardrails-governance', title: 'Guardrails & Governance', order: 8 },
					{ id: 'harness/guide/privacy-detectors', title: 'Privacy Detectors', order: 9 },
					{ id: 'harness/guide/custom-adapters', title: 'Custom Adapters', order: 10 },
					{ id: 'harness/guide/testing-and-evaluations', title: 'Testing & Evaluations', order: 11 },
					{ id: 'harness/guide/observability-operations', title: 'Observability & Operations', order: 12 },
					{

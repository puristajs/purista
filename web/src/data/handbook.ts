		...
		cards: [
			{
				...
				items: [
					...
					{ id: 'harness/guide/sandboxing-and-mcp', title: 'Sandboxing & MCP', order: 6 },
					{ id: 'harness/guide/agents-workflows-state', title: 'Agents, Workflows & State', order: 7 },
					{ id: 'harness/guide/durable-workflows-and-queues', title: 'Durable Workflows & Queues', order: 8 },
					{ id: 'harness/guide/guardrails-governance', title: 'Guardrails & Governance', order: 9 },
					{ id: 'harness/guide/privacy-detectors', title: 'Privacy Detectors', order: 10 },
					{ id: 'harness/guide/custom-adapters', title: 'Custom Adapters', order: 11 },
					{ id: 'harness/guide/testing-and-evaluations', title: 'Testing & Evaluations', order: 12 },
					{ id: 'harness/guide/observability-operations', title: 'Observability & Operations', order: 13 },
					{

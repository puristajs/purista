...
const handbookCompatibilityAliasInputs: HandbookCompatibilityAlias[] = [
	...
	{ sourceRoute: '/handbook/stores/state-store/', targetTopicId: 'framework/configure-applications/state-stores', disposition: 'merge-before-redirect' },
	...
	{ sourceRoute: '/handbook/3_eco_system/stores/default_state_store/', targetTopicId: 'framework/configure-applications/state-stores/default', disposition: 'merge-before-redirect' },
	{ sourceRoute: '/handbook/3_eco_system/stores/redis_state_store/', targetTopicId: 'framework/configure-applications/state-stores/redis', disposition: 'merge-before-redirect' },
	{ sourceRoute: '/handbook/3_eco_system/stores/nats_state_store/', targetTopicId: 'framework/configure-applications/state-stores/nats-jetstream-kv', disposition: 'merge-before-redirect' },
	{ sourceRoute: '/handbook/3_eco_system/stores/dapr_state_store/', targetTopicId: 'framework/configure-applications/state-stores/dapr', disposition: 'merge-before-redirect' },
...
const frameworkReadyCompatibilityAliases: HandbookCompatibilityAlias[] = [
	...
	{ sourceRoute: '/handbook/patterns/scheduling/', targetTopicId: 'framework/build-services/schedule-work', disposition: 'redirect' },
	{ sourceRoute: '/handbook/learn/', targetTopicId: 'framework/start', disposition: 'redirect' },
	{ sourceRoute: '/handbook/mental-model/', targetTopicId: 'framework/understand-the-framework', disposition: 'redirect' },
	{ sourceRoute: '/handbook/service/', targetTopicId: 'framework/build-services', disposition: 'redirect' },
	{ sourceRoute: '/handbook/blocks/', targetTopicId: 'framework/build-services', disposition: 'redirect' },
	{ sourceRoute: '/handbook/stores/', targetTopicId: 'framework/configure-applications', disposition: 'redirect' },
	{ sourceRoute: '/handbook/expose/', targetTopicId: 'framework/expose-and-consume-services', disposition: 'redirect' },
	{ sourceRoute: '/handbook/bridges/', targetTopicId: 'framework/connect-distributed-infrastructure', disposition: 'redirect' },
	{ sourceRoute: '/handbook/patterns/', targetTopicId: 'framework/apply-patterns-and-recipes', disposition: 'redirect' },
	{ sourceRoute: '/handbook/ops/', targetTopicId: 'framework/secure-and-operate', disposition: 'redirect' },
	{ sourceRoute: '/handbook/patterns/event-sourcing/', targetTopicId: 'framework/apply-patterns-and-recipes/event-sourcing', disposition: 'redirect' },
	{ sourceRoute: '/handbook/patterns/cqrs/', targetTopicId: 'framework/apply-patterns-and-recipes/cqrs-and-projections', disposition: 'redirect' },
	{ sourceRoute: '/handbook/patterns/workflows/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/patterns/temporal/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/apply-patterns-and-recipes/schedule-event-queue-result/', targetTopicId: 'framework/build-services/schedule-work', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/build-services/schedule-event-queue-result/', targetTopicId: 'framework/build-services/schedule-work', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/build-services/schedule-event-queue-result/create-a-schedule-and-choose-a-target/', targetTopicId: 'framework/build-services/schedule-work/create-a-schedule-and-choose-a-target', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/build-services/schedule-event-queue-result/emit-enqueue-or-invoke-on-a-schedule/', targetTopicId: 'framework/build-services/schedule-work/emit-enqueue-or-invoke-on-a-schedule', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/build-services/schedule-event-queue-result/export-and-deploy-schedules/', targetTopicId: 'framework/build-services/schedule-work/export-and-deploy-schedules', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/build-services/schedule-event-queue-result/handle-missed-runs-concurrency-and-duplicates/', targetTopicId: 'framework/build-services/schedule-work/handle-missed-runs-concurrency-and-duplicates', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/build-services/schedule-event-queue-result/test-scheduled-behavior/', targetTopicId: 'framework/build-services/schedule-work/test-scheduled-behavior', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/', targetTopicId: 'framework/configure-applications/state-stores', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/dapr/', targetTopicId: 'framework/configure-applications/state-stores/dapr', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/keys-namespaces-isolation-and-consistency/', targetTopicId: 'framework/configure-applications/state-stores/keys-namespaces-isolation-and-consistency', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/default/', targetTopicId: 'framework/configure-applications/state-stores/default', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/nats-jetstream-kv/', targetTopicId: 'framework/configure-applications/state-stores/nats-jetstream-kv', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/redis/', targetTopicId: 'framework/configure-applications/state-stores/redis', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/custom-state-store/', targetTopicId: 'framework/configure-applications/state-stores/custom-state-store', disposition: 'redirect' },
	{ sourceRoute: '/handbook/framework/persist-application-state/test-and-migrate-state/', targetTopicId: 'framework/configure-applications/state-stores/test-and-migrate-state', disposition: 'redirect' },
	...
	{ sourceRoute: '/handbook/framework/build-services/ai-powered-services/configure-an-attached-agent/', targetTopicId: 'framework/build-ai-powered-services/build-and-mount-the-first-agent', disposition: 'redirect' },
	...
	{ sourceRoute: '/handbook/framework/build-services/ai-powered-services/expose-and-invoke-agents/', targetTopicId: 'framework/build-ai-powered-services/invoke-and-expose-a-harness-target', disposition: 'redirect' },
	...
	{ sourceRoute: '/handbook/5_deploy_and_scale/serverless_function_fass/', targetTopicId: 'framework/deploy-applications/serverless-and-edge', disposition: 'redirect' },
	{ sourceRoute: '/handbook/5_deploy_and_scale/edge/', targetTopicId: 'framework/deploy-applications/serverless-and-edge', disposition: 'redirect' },
	{ sourceRoute: '/handbook/6_integrations/temporal_and_purista/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/6_integrations/temporal_and_purista/why_to_use_temporal_and_purista/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/6_integrations/temporal_and_purista/setup_temporal/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/6_integrations/temporal_and_purista/connect_temporal_with_purista/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/6_integrations/temporal_and_purista/connect_purista_to_temporal/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	{ sourceRoute: '/handbook/6_integrations/temporal_and_purista/add_opentelementry/', targetTopicId: 'framework/apply-patterns-and-recipes/long-running-workflows-with-temporal', disposition: 'redirect' },
	...
	{ sourceRoute: '/handbook/2_building_business-logic/stores/state-stores/', targetTopicId: 'framework/configure-applications/state-stores', disposition: 'redirect' },
	...
	{ sourceRoute: '/handbook/6_integrations/enterprise_interoperability/scheduling/', targetTopicId: 'framework/build-services/schedule-work', disposition: 'redirect' },

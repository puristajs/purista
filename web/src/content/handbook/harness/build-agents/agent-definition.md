...
| `permissions` | Optional | Adds allow, deny, path/command patterns, or immediate approval to selected mutating built-ins. It does not authorize application tools. | [Set tool permissions](/handbook/harness/secure-and-govern/tool-permissions/) |

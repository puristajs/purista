...
isolation by itself. See [key and consistency design](/handbook/framework/configure-applications/state-stores/keys-namespaces-isolation-and-consistency/) before using this pattern for a real side effect.
...
Choose a durable [state-store adapter](/handbook/framework/configure-applications/state-stores/)

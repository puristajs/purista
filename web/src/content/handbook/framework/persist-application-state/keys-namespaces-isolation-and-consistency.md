...
Next: choose the [local default store](/handbook/framework/persist-application-state/default/), a durable adapter, or follow [test and migrate state](/handbook/framework/persist-application-state/test-and-migrate-state/) for a safe change.

...
import * as activities from './activities/index.js'
import { getInvoke } from './getInvoke.js' // [!code ++]
...
We now have the communication from Temporal to the PURISTA application, and the opposite from the PURISTA application to Temporal.

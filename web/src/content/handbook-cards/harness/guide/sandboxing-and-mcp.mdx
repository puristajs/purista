...
and cleanup. Use [Custom Adapters](/handbook/harness/guide/custom-adapters/)
...
when the plugin is reviewed. Read [Agent Plugins](/handbook/harness/guide/agent-plugins/)
...
Continue with [Durable Workflows & Queues](/handbook/harness/guide/durable-workflows-and-queues/)
when a claims review must survive a worker restart, or
[Custom Adapters](/handbook/harness/guide/custom-adapters/) to build the

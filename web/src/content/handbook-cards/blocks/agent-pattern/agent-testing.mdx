---
title: Testing
description: Test agents with core testing helpers and scripted model providers.
---
...
| **Runtime harness** | `createAgentTestHarness(...)` | Full attached agent definition with model bindings, output validation, and stream execution. |

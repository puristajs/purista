...
The command declares the workflow address with the service name, version, and workflow contract. Its client then uses that same three-part address. A completed run returns the typed workflow output.

...
## Generate the producer and subscriber

Start from the generated banking command, then create the independent monitoring
service and subscription. The event is the only connection between them.

```bash title="Generate the monitoring subscriber"
npm run add:service -- banking-operations --description "Banking monitoring and operations"

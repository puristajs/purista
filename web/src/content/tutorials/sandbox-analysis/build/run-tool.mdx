...
Put business authorization on the published agent target. This protects every
EventBridge caller before Harness opens a sandbox or invokes a model. The HTTP
command remains a small protected projection.

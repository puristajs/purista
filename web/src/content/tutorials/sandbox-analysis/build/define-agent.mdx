...
```
The agent chooses the purpose alias `analysis`. The application binds that
exact alias to a provider and model later. Continue with [Authorize an analysis
request](../authorize-agent/).

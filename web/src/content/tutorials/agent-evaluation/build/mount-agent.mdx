...
Create the complete portable Harness definition with strict input and output
schemas. The same definition is mounted on PURISTA and instantiated directly by
the evaluator.

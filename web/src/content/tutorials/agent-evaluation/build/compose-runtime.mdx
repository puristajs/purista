...
The factory supplies application-owned policy and the singular primary model binding. The server entry point selects OpenAI only for the optional live service.

...
flowchart LR
  ...
  Hono -->|trusted fixture identity| Command[PURISTA command]
...
composition is in `examples/banking/src/index.ts`. The `x-example-actor`
header is a visible local fixture, not production authentication. The next
chapter explains the business permission rules that it already exercises.

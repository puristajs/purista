...
description: Supply the business policy and exact classification model binding at startup.
order: 196
kind: lesson
status: published
---
...
```
The `ai.models.classification` value supplies the provider and model to the mounted

...
```
`classification` is the explicit purpose model alias that runtime composition
binds under `ai.models`. The agent owns schemas, instructions, prompt mapping, and content guardrails.

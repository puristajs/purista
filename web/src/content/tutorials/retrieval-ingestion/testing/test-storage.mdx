...
description: Prove atomic revision replacement, rollback, vector validation, similarity search, and tenant isolation against PostgreSQL.
order: 226
kind: lesson
status: draft
---

Use a real resource contract test for behavior mocks cannot prove.
...
Run it against the local dependency.

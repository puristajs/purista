...
Create the command that starts or resumes the durable answer workflow. It carries the request identity and collection scope into the Harness.
...
```
Check your work: Run `npm run test:rag-retrieval`. The answer command test verifies the workflow request.

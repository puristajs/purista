...
```
The sample source keeps the demonstration short. The form shows loading,
success, and error states, and its responsive card remains usable with a
keyboard or a narrow viewport. A real application would add file parsing,
source review, progress, and revision management around the same protected
command.

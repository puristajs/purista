...
- The internal `purista-skill-maintainer` and `purista-docs-maintainer` skills are exceptions: they may use specs to keep framework skills, docs, examples, and implementation aligned.

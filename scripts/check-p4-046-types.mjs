...
const ownedRootPaths = [
	...
	'packages/core/src/DefaultEventBridge/defaultEventBridge.test.ts',
	'packages/core/src/HarnessMount/dispatcher.test.ts',
	'packages/core/src/HarnessMount/harnessMount.receiver.test.ts',
	'packages/core/src/HarnessMount/harnessMount.queueReceiver.integration.test.ts',
	'packages/core/src/HarnessMount/harnessMount.test.fixture.ts',
	'packages/core/src/HarnessMount/harnessMount.test.ts',
	'packages/core/src/HarnessMount/invocation.ts',
	'packages/core/src/HarnessMount/invocation.test.ts',
	'packages/core/src/HarnessMount/interruptSchema.ts',
	'packages/core/src/HarnessMount/projection.ts',
	'packages/core/src/HarnessMount/queue.ts',
	'packages/core/src/HarnessMount/queue.test.ts',
	'packages/core/src/HarnessMount/queueBinding.ts',
	'packages/core/src/HarnessMount/queueEnvelope.ts',
	'packages/core/src/HarnessMount/queueReferenceRegistry.ts',
	'packages/core/src/HarnessMount/remoteTargetContract.ts',
	'packages/core/src/HarnessMount/remoteTargetContract.test.ts',
	'packages/core/src/HarnessMount/runtime.ts',
	'packages/core/src/HarnessMount/targetExport.ts',
	...
	'packages/core/src/core/EventBridge/PendingInvocationRegistry.impl.ts',
	'packages/core/src/core/EventBridge/PendingInvocationRegistry.impl.test.ts',
	'packages/core/src/core/helper/getHarnessTransportCorrelationId.impl.ts',
	'packages/core/src/core/helper/getHarnessTransportCorrelationId.test.ts',
	'packages/core/src/core/helper/index.ts',
	'packages/core/src/core/types/commandType/Command.ts',
	'packages/core/src/mocks/messages/getCommandMessage.mock.ts',
	'packages/core/src/helper/exportServiceDefinitions.ts',
	'packages/core/src/helper/exportServiceDefinitions.test.ts',
	'packages/core/src/helper/types/FullDefinition.ts',
	'packages/core/src/helper/types/FullServiceDefinition.ts',
	'packages/core/src/helper/types/HarnessServiceDefinition.ts',
	'packages/core/src/helper/types/ServiceDefinitions.ts',
	'packages/core/src/helper/types/index.ts',
	'packages/core/src/ClientBuilder/ClientBuilder.impl.ts',
	'packages/core/src/ClientBuilder/getWriter.impl.ts',
	'packages/core/src/ClientBuilder/harnessClient.ts',
	'packages/core/src/ClientBuilder/harnessClients.test.ts',
	'packages/core/src/ClientBuilder/harnessCodegen.ts',
	'packages/core/src/ClientBuilder/index.ts',
	'packages/core/src/ClientBuilder/mergeIntoServiceDefinition.impl.ts',
	'packages/core/src/ClientBuilder/mergeIntoServiceDefintion.impl.ts',
	'packages/core/src/ClientBuilder/mergeIntoServiceDefintion.test.ts',
	'packages/core/src/ClientBuilder/metaToFunctionBridge.impl.ts',
	'packages/core/src/ClientBuilder/metaToFunctionHttp.impl.ts',
	'packages/core/src/ClientBuilder/metaToFunctionHttp.test.ts',
	'packages/core/src/ClientBuilder/schema/configSchema.ts',
	'packages/core/src/ClientBuilder/schema/eventBridgeClientConfigSchema.ts',
	'packages/core/src/ClientBuilder/schema/httpClientConfigSchema.ts',
	'packages/core/src/ClientBuilder/schema/index.ts',
	'packages/core/src/ClientBuilder/types/ClientBuilderConfig.ts',
	'packages/core/src/ClientBuilder/types/ClientBuilderEvents.ts',
	'packages/core/src/ClientBuilder/types/Config.ts',
	'packages/core/src/ClientBuilder/types/index.ts',
]
...
if (
	...
	process.stdout.write('P4-046 TypeScript gate passed: 0 owned and 23 exact transitive P4-001 diagnostics.\n')
	process.exit(0)
}

process.stderr.write('P4-046 TypeScript gate failed.\n')
...
if (missingTransitive.length === 0 && unexpectedTransitive.length === 0) {
	process.stderr.write('Transitive P4-001 baseline matched exactly: 23 diagnostics.\n')
}
process.exit(1)
...
function failWithConfigDiagnostics(diagnostics) {
	process.stderr.write('P4-046 TypeScript gate failed before program creation.\n')

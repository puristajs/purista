...
| --- | --- | --- | --- | --- | --- |
| `answer_transaction_question` | `npm run add:agent ...` | native module schemas and instructions | `supportHarness.use(...)` and `.mountHarness(...)` | `ai.models.primary` | standalone Harness and EventBridge tests |

...
> **AgentInvokeList** = `Record`\<`string`, `Record`\<`string`, \{ `call?`: (`payload`, `parameter?`) => [`AgentInvocation`](../interfaces/AgentInvocation.md)\<[`AgentProtocolResponse`](AgentProtocolResponse.md)\>; `parameterSchema?`: [`Schema`](Schema.md); `payloadSchema?`: [`Schema`](Schema.md); \}\>\>

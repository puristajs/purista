...
[PURISTA API](../../../packages.md) / [@purista/core](../README.md) / QueueRetryRequest

# Type Alias: QueueRetryRequest

> **QueueRetryRequest** = `object`

Defined in: [core/QueueBridge/types/QueueRetryRequest.ts:1](https://github.com/puristajs/purista/blob/master/packages/core/src/core/QueueBridge/types/QueueRetryRequest.ts#L1)

...
[PURISTA API](../../../packages.md) / [@purista/core](../README.md) / QueueLeaseOptions

# Type Alias: QueueLeaseOptions

> **QueueLeaseOptions** = `object`

Defined in: [core/QueueBridge/types/QueueLeaseOptions.ts:1](https://github.com/puristajs/purista/blob/master/packages/core/src/core/QueueBridge/types/QueueLeaseOptions.ts#L1)

...
[PURISTA API](../../../packages.md) / [@purista/core](../README.md) / JsonSchemaOptions

# Type Alias: JsonSchemaOptions

> **JsonSchemaOptions** = `object`

Defined in: [schema/standardSchema.ts:22](https://github.com/puristajs/purista/blob/master/packages/core/src/schema/standardSchema.ts#L22)

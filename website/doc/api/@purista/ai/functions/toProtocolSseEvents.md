...
> **toProtocolSseEvents**(`envelopes`, `protocol`, `options?`): `AsyncGenerator`\<[`WireEvent`](../type-aliases/WireEvent.md)\>

Defined in: [packages/ai/src/protocol/sse.ts:23](https://github.com/puristajs/purista/blob/9cd53c1e49bdea4c772d707ebf60458f2dc7435f/packages/ai/src/protocol/sse.ts#L23)

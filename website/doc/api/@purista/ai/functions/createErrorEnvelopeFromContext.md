...
[PURISTA API](../../../packages.md) / [@purista/ai](../README.md) / createErrorEnvelopeFromContext

# Function: createErrorEnvelopeFromContext()

> **createErrorEnvelopeFromContext**(`context`, `error`, `overrides?`): `object`

Defined in: [packages/ai/src/protocol/purista.ts:56](https://github.com/puristajs/purista/blob/9cd53c1e49bdea4c772d707ebf60458f2dc7435f/packages/ai/src/protocol/purista.ts#L56)
...
[`PuristaProtocolOptions`](../type-aliases/PuristaProtocolOptions.md) & `object`
...
> `optional` **role**: `"user"` \| `"assistant"` \| `"tool"` \| `"system"` \| `"developer"`

...
[PURISTA API](../../../packages.md) / [@purista/ai](../README.md) / toPlanArtifactPayload

# Function: toPlanArtifactPayload()

> **toPlanArtifactPayload**(`state`): `object`

Defined in: packages/ai/src/protocol/taskArtifacts.ts:165

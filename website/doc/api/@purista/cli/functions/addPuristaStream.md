...
[PURISTA API](../../../packages.md) / [@purista/cli](../README.md) / addPuristaStream

# Function: addPuristaStream()

> **addPuristaStream**(`input`): `Promise`\<`void`\>

Defined in: [packages/cli/src/api/addPuristaStream.ts:17](https://github.com/puristajs/purista/blob/28d9337ab7fa6d33001a8b6c36fb84bb9236b736/packages/cli/src/api/addPuristaStream.ts#L17)

...
[PURISTA API](../../../packages.md) / [@purista/cli](../README.md) / getStreamSchemaFileContent

# Function: getStreamSchemaFileContent()

> **getStreamSchemaFileContent**(`input`): `string`

Defined in: [packages/cli/src/api/content/stream/getStreamSchemaFileContent.ts:6](https://github.com/puristajs/purista/blob/26267b98f9adfa85c2bf732383fb98c6a2225b0f/packages/cli/src/api/content/stream/getStreamSchemaFileContent.ts#L6)

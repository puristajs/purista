...
[PURISTA API](../../../packages.md) / [@purista/cli](../README.md) / getStreamTypeFileContent

# Function: getStreamTypeFileContent()

> **getStreamTypeFileContent**(`input`): `string`

Defined in: [packages/cli/src/api/content/stream/getStreamTypeFileContent.ts:6](https://github.com/puristajs/purista/blob/a54e4eedd3278d44c6382db014435e1a5908fb6f/packages/cli/src/api/content/stream/getStreamTypeFileContent.ts#L6)

...
[PURISTA API](../../../packages.md) / [@purista/cli](../README.md) / getQueueBuilderFileContent

# Function: getQueueBuilderFileContent()

> **getQueueBuilderFileContent**(`input`): `string`

Defined in: [packages/cli/src/api/content/queue/getQueueBuilderFileContent.ts:7](https://github.com/puristajs/purista/blob/6e0354b1e51abc331c66c917ee95829470c9fba2/packages/cli/src/api/content/queue/getQueueBuilderFileContent.ts#L7)

...
[PURISTA API](../../../packages.md) / [@purista/cli](../README.md) / getSubscriptionTestFileContent

# Function: getSubscriptionTestFileContent()

> **getSubscriptionTestFileContent**(`input`): `string`

Defined in: [packages/cli/src/api/content/subscription/getSubscriptionTestFileContent.ts:7](https://github.com/puristajs/purista/blob/26267b98f9adfa85c2bf732383fb98c6a2225b0f/packages/cli/src/api/content/subscription/getSubscriptionTestFileContent.ts#L7)

...
[PURISTA API](../../../packages.md) / [@purista/cli](../README.md) / getCommandTestFileContent

# Function: getCommandTestFileContent()

> **getCommandTestFileContent**(`input`): `string`

Defined in: [packages/cli/src/api/content/command/getCommandTestFileContent.ts:7](https://github.com/puristajs/purista/blob/430e29c621b412b5f21de4eb9697723299bc616e/packages/cli/src/api/content/command/getCommandTestFileContent.ts#L7)

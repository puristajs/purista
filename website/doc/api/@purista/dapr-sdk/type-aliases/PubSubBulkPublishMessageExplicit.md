...
[PURISTA API](../../../packages.md) / [@purista/dapr-sdk](../README.md) / PubSubBulkPublishMessageExplicit

# Type Alias: PubSubBulkPublishMessageExplicit

> **PubSubBulkPublishMessageExplicit** = `object`

Defined in: [dapr-sdk/src/types/pubsub/PubSubBulkPublishMessage.type.ts:16](https://github.com/puristajs/purista/blob/master/packages/dapr-sdk/src/types/pubsub/PubSubBulkPublishMessage.type.ts#L16)
...
Defined in: [dapr-sdk/src/types/pubsub/PubSubBulkPublishMessage.type.ts:18](https://github.com/puristajs/purista/blob/master/packages/dapr-sdk/src/types/pubsub/PubSubBulkPublishMessage.type.ts#L18)

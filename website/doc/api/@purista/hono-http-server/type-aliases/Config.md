...
[PURISTA API](../../../packages.md) / [@purista/hono-http-server](../README.md) / Config

# Type Alias: Config

> **Config** = `object`

Defined in: [hono-http-server/src/helper/addPathToOpenApi.ts:11](https://github.com/puristajs/purista/blob/master/packages/hono-http-server/src/helper/addPathToOpenApi.ts#L11)

[PURISTA API - v1.4.9](../README.md) / [Modules](../modules.md) / @purista/core
...
[packages/core/src/core/types/ServiceEvents.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ServiceEvents.ts#L11)
...
[packages/core/src/core/Service/Service.impl.ts:73](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/Service/Service.impl.ts#L73)
...
[packages/core/src/ServiceBuilder/ServiceBuilder.impl.ts:37](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/ServiceBuilder/ServiceBuilder.impl.ts#L37)
...
[packages/core/src/core/types/ServiceClass.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ServiceClass.ts#L11)
...
[packages/core/src/core/types/ServiceConstructorInput.ts:15](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ServiceConstructorInput.ts#L15)
...
[packages/core/src/core/types/ServiceEvents.ts:54](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ServiceEvents.ts#L54)
...
[packages/core/src/CommandDefinitionBuilder/CommandDefinitionBuilder.impl.ts:31](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/CommandDefinitionBuilder/CommandDefinitionBuilder.impl.ts#L31)
...
[packages/core/src/core/types/commandType/CommandAfterGuardHook.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandAfterGuardHook.ts#L10)
...
[packages/core/src/core/types/commandType/CommandBeforeGuardHook.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandBeforeGuardHook.ts#L11)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `call` | [`CommandFunction`](purista_core.md#commandfunction)<`ServiceClassType`, `MessagePayloadType`, `MessageParamsType`, `MessagePayloadType`, `MessageParamsType`, `MessageResultType`\> | the command function |
...
[packages/core/src/core/types/commandType/CommandDefinition.ts:17](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandDefinition.ts#L17)

___

### CommandErrorResponse

Ƭ **CommandErrorResponse**: { `contentEncoding`: ``"utf-8"`` ; `contentType`: ``"application/json"`` ; `correlationId`: [`CorrelationId`](purista_core.md#correlationid) ; `isHandledError`: `boolean` ; `messageType`: [`CommandErrorResponse`](../enums/purista_core.EBMessageType.md#commanderrorresponse) ; `payload`: { `data?`: `unknown` ; `message`: `string` ; `status`: [`StatusCode`](../enums/purista_core.StatusCode.md)  } ; `receiver`: [`EBMessageAddress`](purista_core.md#ebmessageaddress) ; `sender`: [`EBMessageAddress`](purista_core.md#ebmessageaddress)  } & [`EBMessageBase`](purista_core.md#ebmessagebase)

CommandErrorResponse is a response to a specific previously received command which indicates some failure.

#### Defined in

[packages/core/src/core/types/commandType/CommandErrorResponse.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandErrorResponse.ts#L12)
...
[packages/core/src/core/types/commandType/CommandFunction.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandFunction.ts#L9)

___

### CommandFunctionContext

Ƭ **CommandFunctionContext**<`MessagePayloadType`, `MessageParamsType`\>: [`ContextBase`](purista_core.md#contextbase) & [`CommandFunctionContextEnhancements`](purista_core.md#commandfunctioncontextenhancements)<`MessagePayloadType`, `MessageParamsType`\>
...
[packages/core/src/core/types/commandType/CommandFunctionContext.ts:46](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandFunctionContext.ts#L46)
...
[packages/core/src/core/types/commandType/CommandResponse.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandResponse.ts#L9)
...
[packages/core/src/core/types/commandType/CommandSuccessResponse.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandSuccessResponse.ts#L12)

___

### CommandTransformFunctionContext

Ƭ **CommandTransformFunctionContext**<`PayloadType`, `ParameterType`\>: [`ContextBase`](purista_core.md#contextbase) & { `message`: `Readonly`<[`Command`](purista_core.md#command)<`PayloadType`, `ParameterType`\>\>  }
...
[packages/core/src/core/types/commandType/CommandTransformFunctionContext.ts:7](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandTransformFunctionContext.ts#L7)
...
[packages/core/src/core/types/commandType/CommandTransformInputHook.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandTransformInputHook.ts#L12)
...
[packages/core/src/core/types/commandType/CommandTransformOutputHook.ts:7](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandTransformOutputHook.ts#L7)

___

### isCommand

▸ **isCommand**(`message`): message is Command
...
[packages/core/src/core/types/commandType/isCommand.impl.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/isCommand.impl.ts#L12)
...
[packages/core/src/core/types/commandType/isCommandErrorResponse.impl.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/isCommandErrorResponse.impl.ts#L12)
...
[packages/core/src/core/types/commandType/isCommandResponse.impl.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/isCommandResponse.impl.ts#L12)

___

### isCommandSuccessResponse

▸ **isCommandSuccessResponse**(`message`): message is CommandSuccessResponse
...
[packages/core/src/core/types/commandType/isCommandSuccessResponse.impl.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/isCommandSuccessResponse.impl.ts#L12)
...
[packages/core/src/core/ConfigStore/ConfigStoreBaseClass.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/ConfigStore/ConfigStoreBaseClass.impl.ts#L11)
...
[packages/core/src/DefaultConfigStore/DefaultConfigStore.impl.ts:25](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultConfigStore/DefaultConfigStore.impl.ts#L25)
...
[packages/core/src/DefaultSecretStore/DefaultSecretStore.impl.ts:33](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultSecretStore/DefaultSecretStore.impl.ts#L33)
...
[packages/core/src/DefaultStateStore/DefaultStateStore.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultStateStore/DefaultStateStore.impl.ts#L11)
...
[packages/core/src/core/SecretStore/SecretStoreBaseClass.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/SecretStore/SecretStoreBaseClass.impl.ts#L11)
...
[packages/core/src/core/StateStore/StateStoreBaseClass.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/StateStore/StateStoreBaseClass.impl.ts#L11)
...
[packages/core/src/core/ConfigStore/types/ConfigStore.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/ConfigStore/types/ConfigStore.ts#L10)
...
[packages/core/src/core/SecretStore/types/SecretStore.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/SecretStore/types/SecretStore.ts#L9)
...
[packages/core/src/core/StateStore/types/StateStore.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/StateStore/types/StateStore.ts#L10)
...
[packages/core/src/core/ConfigStore/types/ConfigDeleteFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/ConfigStore/types/ConfigDeleteFunction.ts#L2)
...
[packages/core/src/core/ConfigStore/types/ConfigGetterFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/ConfigStore/types/ConfigGetterFunction.ts#L2)
...
[packages/core/src/core/ConfigStore/types/ConfigSetterFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/ConfigStore/types/ConfigSetterFunction.ts#L2)
...
[packages/core/src/core/SecretStore/types/SecretDeleteFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/SecretStore/types/SecretDeleteFunction.ts#L2)
...
[packages/core/src/core/SecretStore/types/SecretGetterFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/SecretStore/types/SecretGetterFunction.ts#L2)
...
[packages/core/src/core/SecretStore/types/SecretSetterFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/SecretStore/types/SecretSetterFunction.ts#L2)
...
[packages/core/src/core/StateStore/types/StateDeleteFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/StateStore/types/StateDeleteFunction.ts#L2)
...
[packages/core/src/core/StateStore/types/StateGetterFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/StateStore/types/StateGetterFunction.ts#L2)
...
[packages/core/src/core/StateStore/types/StateSetterFunction.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/StateStore/types/StateSetterFunction.ts#L2)
...
[packages/core/src/DefaultEventBridge/DefaultEventBridge.impl.ts:50](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/DefaultEventBridge.impl.ts#L50)
...
[packages/core/src/core/EventBridge/EventBridgeBaseClass.impl.ts:17](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/EventBridge/EventBridgeBaseClass.impl.ts#L17)
...
[packages/core/src/core/EventBridge/types/EventBridge.ts:19](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/EventBridge/types/EventBridge.ts#L19)
...
[packages/core/src/core/EventBridge/types/EventBridgeEvents.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/EventBridge/types/EventBridgeEvents.ts#L9)
...
[packages/core/src/core/helper/getCommandQueueName.impl.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getCommandQueueName.impl.ts#L10)
...
[packages/core/src/SubscriptionDefinitionBuilder/SubscriptionDefinitionBuilder.impl.ts:30](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/SubscriptionDefinitionBuilder/SubscriptionDefinitionBuilder.impl.ts#L30)
...
[packages/core/src/core/types/subscription/Subscription.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/Subscription.ts#L12)
...
[packages/core/src/core/types/subscription/SubscriptionAfterGuardHook.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionAfterGuardHook.ts#L10)
...
[packages/core/src/core/types/subscription/SubscriptionBeforeGuardHook.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionBeforeGuardHook.ts#L11)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `call` | [`SubscriptionFunction`](purista_core.md#subscriptionfunction)<`ServiceClassType`, `MessagePayloadType`, `MessageParamsType`, `MessagePayloadType`, `MessageParamsType`, `MessageResultType`\> | the subscription function |
...
[packages/core/src/core/types/subscription/SubscriptionDefinition.ts:20](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionDefinition.ts#L20)
...
[packages/core/src/core/types/subscription/SubscriptionFunction.ts:8](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionFunction.ts#L8)

___

### SubscriptionFunctionContext

Ƭ **SubscriptionFunctionContext**: [`ContextBase`](purista_core.md#contextbase) & [`SubscriptionFunctionContextEnhancements`](purista_core.md#subscriptionfunctioncontextenhancements)

The subscription function context which will be passed into subscription function.

#### Defined in

[packages/core/src/core/types/subscription/SubscriptionFunctionContext.ts:46](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionFunctionContext.ts#L46)
...
[packages/core/src/core/types/subscription/SubscriptionFunctionContext.ts:15](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionFunctionContext.ts#L15)

___

### SubscriptionTransformFunctionContext

Ƭ **SubscriptionTransformFunctionContext**: [`ContextBase`](purista_core.md#contextbase) & { `message`: `Readonly`<[`EBMessage`](purista_core.md#ebmessage)\>  }

#### Defined in

[packages/core/src/core/types/subscription/SubscriptionTransformFunctionContext.ts:7](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionTransformFunctionContext.ts#L7)
...
[packages/core/src/core/types/subscription/SubscriptionTransformInputHook.ts:6](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionTransformInputHook.ts#L6)
...
[packages/core/src/core/types/subscription/SubscriptionTransformOutputHook.ts:8](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionTransformOutputHook.ts#L8)
...
[packages/core/src/core/types/commandType/Command.ts:17](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/Command.ts#L17)
...
[packages/core/src/core/types/commandType/CommandDefinitionList.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandDefinitionList.ts#L12)
...
[packages/core/src/core/types/commandType/CommandDefinitionMetadataBase.ts:5](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/commandType/CommandDefinitionMetadataBase.ts#L5)
...
[packages/core/src/core/types/Complete.ts:20](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/Complete.ts#L20)
...
[packages/core/src/core/HttpServer/types/CompressionMethod.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/HttpServer/types/CompressionMethod.ts#L1)
...
[packages/core/src/core/types/ContentType.ts:6](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ContentType.ts#L6)
...
[packages/core/src/core/types/ContextBase.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ContextBase.ts#L12)
...
[packages/core/src/core/types/CorrelationId.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/CorrelationId.ts#L2)
...
[packages/core/src/core/types/CustomMessage.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/CustomMessage.ts#L10)

___

### DefaultConfigStoreConfig

Ƭ **DefaultConfigStoreConfig**: `Object`

#### Defined in

[packages/core/src/DefaultConfigStore/types/DefaultConfigStoreConfig.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultConfigStore/types/DefaultConfigStoreConfig.ts#L1)
...
[packages/core/src/DefaultEventBridge/types/DefaultEventBridgeConfig.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/types/DefaultEventBridgeConfig.ts#L4)

___

### DefaultSecretStoreConfig

Ƭ **DefaultSecretStoreConfig**: `Record`<`string`, `string`\>

#### Defined in

[packages/core/src/DefaultSecretStore/types/DefaultSecretStoreConfig.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultSecretStore/types/DefaultSecretStoreConfig.ts#L1)
...
[packages/core/src/DefaultStateStore/types/DefaultStateStoreConfig.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultStateStore/types/DefaultStateStoreConfig.ts#L1)
...
[packages/core/src/core/types/DefinitionEventBridgeConfig.ts:6](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/DefinitionEventBridgeConfig.ts#L6)
...
[packages/core/src/core/types/EBMessage.ts:8](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/EBMessage.ts#L8)
...
[packages/core/src/core/types/EBMessageAddress.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/EBMessageAddress.ts#L4)
...
[packages/core/src/core/types/EBMessageBase.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/EBMessageBase.ts#L11)
...
[packages/core/src/core/types/EBMessageId.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/EBMessageId.ts#L4)
...
[packages/core/src/core/types/EmitCustomMessageFunction.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/EmitCustomMessageFunction.ts#L10)
...
[packages/core/src/core/types/ErrorResponsePayload.ts:7](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ErrorResponsePayload.ts#L7)
...
[packages/core/src/core/EventBridge/types/EventBridgeConfig.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/EventBridge/types/EventBridgeConfig.ts#L10)

___

### EventBridgeEvents

Ƭ **EventBridgeEvents**: [`EventBridgeEventsBasic`](purista_core.md#eventbridgeeventsbasic) & [`addPrefixToObject`](purista_core.md#addprefixtoobject)<[`CustomEvents`](purista_core.internal.md#customevents-1), ``"adapter-"``\>

#### Defined in

[packages/core/src/core/EventBridge/types/EventBridgeEvents.ts:30](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/EventBridge/types/EventBridgeEvents.ts#L30)
...
[packages/core/src/core/types/GenericEventEmitter.ts:5](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/GenericEventEmitter.ts#L5)
...
[packages/core/src/core/types/GenericEventEmitter.ts:3](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/GenericEventEmitter.ts#L3)

___

### HttpExposedServiceMeta

Ƭ **HttpExposedServiceMeta**<`ParameterType`\>: [`CommandDefinitionMetadataBase`](purista_core.md#commanddefinitionmetadatabase) & { `expose`: { `http`: { `method`: ``"GET"`` \| ``"POST"`` \| ``"PATCH"`` \| ``"PUT"`` \| ``"DELETE"`` ; `openApi?`: { `additionalStatusCodes?`: [`StatusCode`](../enums/purista_core.StatusCode.md)[] ; `description`: `string` ; `isSecure`: `boolean` ; `operationId?`: `string` ; `query?`: [`QueryParameter`](purista_core.md#queryparameter)<`ParameterType`\>[] ; `summary`: `string` ; `tags?`: `string`[]  } ; `path`: `string`  }  }  }
...
[packages/core/src/core/HttpServer/types/HttpExposedServiceMeta.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/HttpServer/types/HttpExposedServiceMeta.ts#L4)
...
[packages/core/src/core/types/infoType/InfoInvokeTimeout.ts:22](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoInvokeTimeout.ts#L22)
...
[packages/core/src/core/types/infoType/InfoInvokeTimeout.ts:6](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoInvokeTimeout.ts#L6)
...
[packages/core/src/core/types/infoType/InfoMessage.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoMessage.ts#L11)
...
[packages/core/src/core/types/infoType/InfoMessage.ts:21](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoMessage.ts#L21)

___

### InfoServiceBase

Ƭ **InfoServiceBase**: { `contentEncoding`: ``"utf-8"`` ; `contentType`: ``"application/json"`` ; `payload?`: `unknown` ; `sender`: { `serviceName`: `string` ; `serviceTarget`: `string` ; `serviceVersion`: `string`  }  } & [`EBMessageBase`](purista_core.md#ebmessagebase)

#### Defined in

[packages/core/src/core/types/infoType/InfoServiceBase.ts:3](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceBase.ts#L3)
...
[packages/core/src/core/types/infoType/InfoServiceDrain.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceDrain.ts#L4)
...
[packages/core/src/core/types/infoType/InfoServiceFunctionAdded.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceFunctionAdded.ts#L4)
...
[packages/core/src/core/types/infoType/InfoServiceInit.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceInit.ts#L4)
...
[packages/core/src/core/types/infoType/InfoServiceNotReady.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceNotReady.ts#L4)
...
[packages/core/src/core/types/infoType/InfoServiceReady.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceReady.ts#L4)
...
[packages/core/src/core/types/infoType/InfoServiceShutdown.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoServiceShutdown.ts#L4)
...
[packages/core/src/core/types/infoType/InfoSubscriptionError.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoSubscriptionError.ts#L4)
...
[packages/core/src/core/types/InstanceId.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/InstanceId.ts#L2)
...
[packages/core/src/core/types/Logger.ts:17](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/Logger.ts#L17)
...
[packages/core/src/core/types/LogLevelName.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/LogLevelName.ts#L1)
...
[packages/core/src/core/types/Logger.ts:5](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/Logger.ts#L5)
...
[packages/core/src/mocks/getLogger.mock.ts:41](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getLogger.mock.ts#L41)
...
[packages/core/src/ServiceBuilder/ServiceBuilder.impl.ts:27](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/ServiceBuilder/ServiceBuilder.impl.ts#L27)
...
[packages/core/src/DefaultEventBridge/types/PendingInvocations.ts:3](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/types/PendingInvocations.ts#L3)
...
[packages/core/src/core/types/PrincipalId.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/PrincipalId.ts#L2)
...
[packages/core/src/core/HttpServer/types/QueryParameter.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/HttpServer/types/QueryParameter.ts#L1)

___

### ServiceEvents

Ƭ **ServiceEvents**: [`ServiceEventsInternal`](purista_core.md#serviceeventsinternal) & [`addPrefixToObject`](purista_core.md#addprefixtoobject)<[`CustomEvents`](purista_core.internal.md#customevents), ``"custom-"``\> & [`addPrefixToObject`](purista_core.md#addprefixtoobject)<[`CustomEvents`](purista_core.internal.md#customevents), ``"misc-"``\>
...
[packages/core/src/core/types/ServiceEvents.ts:98](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/ServiceEvents.ts#L98)
...
[packages/core/src/core/types/infoType/ServiceInfoType.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/ServiceInfoType.ts#L4)
...
[packages/core/src/helper/types/ShutdownEntry.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/helper/types/ShutdownEntry.ts#L4)
...
[packages/core/src/core/types/StoreBaseConfig.ts:3](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/StoreBaseConfig.ts#L3)
...
[packages/core/src/core/types/subscription/SubscriptionDefinitionList.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionDefinitionList.ts#L11)
...
[packages/core/src/core/types/subscription/SubscriptionDefinitionMetadataBase.ts:5](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/subscription/SubscriptionDefinitionMetadataBase.ts#L5)
...
[packages/core/src/DefaultEventBridge/types/SubscriptionStorageEntry.ts:3](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/types/SubscriptionStorageEntry.ts#L3)
...
[packages/core/src/core/HttpServer/types/SupportedHttpMethod.ts:2](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/HttpServer/types/SupportedHttpMethod.ts#L2)
...
[packages/core/src/core/types/TraceId.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/TraceId.ts#L4)
...
[packages/core/src/core/types/addPrefixToObject.ts:7](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/addPrefixToObject.ts#L7)
...
[packages/core/src/core/HttpServer/MinContentSizeForCompression.const.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/HttpServer/MinContentSizeForCompression.const.ts#L1)
...
[packages/core/src/core/Service/ServiceInfoValidator.impl.ts:5](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/Service/ServiceInfoValidator.impl.ts#L5)
...
[packages/core/src/core/types/infoType/InfoMessage.ts:30](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/InfoMessage.ts#L30)
...
[packages/core/src/version.ts:1](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/version.ts#L1)
...
[packages/core/src/helper/string/convertToCamelCase.impl.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/helper/string/convertToCamelCase.impl.ts#L9)
...
[packages/core/src/helper/string/convertToKebabCase.impl.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/helper/string/convertToKebabCase.impl.ts#L9)
...
[packages/core/src/helper/string/convertToPascalCase.impl.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/helper/string/convertToPascalCase.impl.ts#L9)
...
[packages/core/src/helper/string/convertToSnakeCase.impl.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/helper/string/convertToSnakeCase.impl.ts#L9)
...
[packages/core/src/core/helper/createErrorResponse.impl.ts:18](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/createErrorResponse.impl.ts#L18)
...
[packages/core/src/core/helper/createInfoMessage.impl.ts:14](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/createInfoMessage.impl.ts#L14)
...
[packages/core/src/core/helper/createSuccessResponse.impl.ts:15](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/createSuccessResponse.impl.ts#L15)
...
[packages/core/src/core/helper/serializeOtp.impl.ts:26](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/serializeOtp.impl.ts#L26)
...
[packages/core/src/core/helper/getCleanedMessage.impl.ts:15](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getCleanedMessage.impl.ts#L15)
...
[packages/core/src/core/helper/getErrorMessageForCode.impl.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getErrorMessageForCode.impl.ts#L10)
...
[packages/core/src/core/helper/getNewCorrelationId.impl.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getNewCorrelationId.impl.ts#L10)
...
[packages/core/src/core/helper/getNewEBMessageId.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getNewEBMessageId.impl.ts#L11)
...
[packages/core/src/core/helper/getNewInstanceId.impl.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getNewInstanceId.impl.ts#L9)
...
[packages/core/src/core/helper/getNewTraceId.impl.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getNewTraceId.impl.ts#L9)
...
[packages/core/src/core/helper/getSubscriptionQueueName.impl.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getSubscriptionQueueName.impl.ts#L10)
...
[packages/core/src/core/helper/getUniqueId.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/getUniqueId.impl.ts#L11)
...
[packages/core/src/helper/gracefulShutdown.ts:36](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/helper/gracefulShutdown.ts#L36)
...
[packages/core/src/core/helper/isDevelop.impl.ts:6](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/isDevelop.impl.ts#L6)
...
[packages/core/src/core/helper/serializeOtp.impl.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/helper/serializeOtp.impl.ts#L11)
...
[packages/core/src/mocks/getCommandContext.mock.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getCommandContext.mock.ts#L12)

___

### getCommandErrorMessageMock

▸ **getCommandErrorMessageMock**(`error?`, `input?`, `commandMessage?`): `Readonly`<[`CommandErrorResponse`](purista_core.md#commanderrorresponse)\>
...
| `input?` | `Partial`<[`CommandErrorResponse`](purista_core.md#commanderrorresponse)\> |
| `commandMessage?` | [`Command`](purista_core.md#command) |

#### Returns

`Readonly`<[`CommandErrorResponse`](purista_core.md#commanderrorresponse)\>

#### Defined in

[packages/core/src/mocks/messages/getCommandErrorMessage.mock.ts:16](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/messages/getCommandErrorMessage.mock.ts#L16)

___

### getCommandMessageMock

▸ **getCommandMessageMock**<`Payload`, `Parameter`\>(`input?`): `Readonly`<[`Command`](purista_core.md#command)<`Payload`, `Parameter`\>\>
...
| Name | Type |
| :------ | :------ |
| `input?` | `Partial`<[`Command`](purista_core.md#command)<`Payload`, `Parameter`\>\> & { `payload?`: { `parameter?`: `Parameter` ; `payload?`: `Payload`  }  } |

#### Returns

`Readonly`<[`Command`](purista_core.md#command)<`Payload`, `Parameter`\>\>

#### Defined in

[packages/core/src/mocks/messages/getCommandMessage.mock.ts:15](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/messages/getCommandMessage.mock.ts#L15)

___

### getCommandSuccessMessageMock

▸ **getCommandSuccessMessageMock**<`PayloadType`\>(`payload`, `input?`, `commandMessage?`): `Readonly`<[`CommandSuccessResponse`](purista_core.md#commandsuccessresponse)<`PayloadType`\>\>
...
| :------ | :------ |
| `payload` | `PayloadType` |
| `input?` | `Partial`<[`CommandSuccessResponse`](purista_core.md#commandsuccessresponse)<`PayloadType`\>\> |
| `commandMessage?` | [`Command`](purista_core.md#command) |

#### Returns

`Readonly`<[`CommandSuccessResponse`](purista_core.md#commandsuccessresponse)<`PayloadType`\>\>

#### Defined in

[packages/core/src/mocks/messages/getCommandSuccessMessage.mock.ts:9](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/messages/getCommandSuccessMessage.mock.ts#L9)
...
| Name | Type |
| :------ | :------ |
| `mock` | [`CommandTransformFunctionContext`](purista_core.md#commandtransformfunctioncontext)<`MessagePayloadType`, `MessageParamsType`\> |
...
[packages/core/src/mocks/getCommandTransformContext.mock.ts:12](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getCommandTransformContext.mock.ts#L12)

___

### getCustomMessageMessageMock

▸ **getCustomMessageMessageMock**<`PayloadType`\>(`eventName`, `payload`, `input?`): `Readonly`<[`CustomMessage`](purista_core.md#custommessage)<`PayloadType`\>\>
...
| `eventName` | `string` |
| `payload` | `PayloadType` |
| `input?` | `Partial`<[`CustomMessage`](purista_core.md#custommessage)<`PayloadType`\>\> |

#### Returns

`Readonly`<[`CustomMessage`](purista_core.md#custommessage)<`PayloadType`\>\>

#### Defined in

[packages/core/src/mocks/messages/getCustomMessage.mock.ts:15](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/messages/getCustomMessage.mock.ts#L15)
...
[packages/core/src/mocks/getEventBridge.mock.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getEventBridge.mock.ts#L10)
...
[packages/core/src/mocks/getLogger.mock.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getLogger.mock.ts#L10)
...
| Name | Type |
| :------ | :------ |
| `mock` | [`SubscriptionFunctionContext`](purista_core.md#subscriptionfunctioncontext) |
| `stubs` | { `emit`: `SinonStub`<`any`[], `any`\> ; `getConfig`: `SinonStub`<`any`[], `any`\> ; `getSecret`: `SinonStub`<`any`[], `any`\> ; `getState`: `SinonStub`<`any`[], `any`\> ; `invoke`: `SinonStub`<`any`[], `any`\> ; `logger`: { `debug`: `SinonStub`<`any`[], `any`\> ; `error`: `SinonStub`<`any`[], `any`\> ; `fatal`: `SinonStub`<`any`[], `any`\> ; `info`: `SinonStub`<`any`[], `any`\> ; `trace`: `SinonStub`<`any`[], `any`\> ; `warn`: `SinonStub`<`any`[], `any`\>  } = logger.stubs; `removeConfig`: `SinonStub`<`any`[], `any`\> ; `removeSecret`: `SinonStub`<`any`[], `any`\> ; `removeState`: `SinonStub`<`any`[], `any`\> ; `setConfig`: `SinonStub`<`any`[], `any`\> ; `setSecret`: `SinonStub`<`any`[], `any`\> ; `setState`: `SinonStub`<`any`[], `any`\> ; `startActiveSpan`: `SinonStub`<`any`[], `any`\> ; `wrapInSpan`: `SinonStub`<`any`[], `any`\>  } |
| `stubs.emit` | `SinonStub`<`any`[], `any`\> |
| `stubs.getConfig` | `SinonStub`<`any`[], `any`\> |
| `stubs.getSecret` | `SinonStub`<`any`[], `any`\> |
...
[packages/core/src/mocks/getSubscriptionContext.mock.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getSubscriptionContext.mock.ts#L11)
...
| Name | Type |
| :------ | :------ |
| `mock` | [`SubscriptionTransformFunctionContext`](purista_core.md#subscriptiontransformfunctioncontext) |
| `stubs` | { `getConfig`: `SinonStub`<`any`[], `any`\> ; `getSecret`: `SinonStub`<`any`[], `any`\> ; `getState`: `SinonStub`<`any`[], `any`\> ; `logger`: { `debug`: `SinonStub`<`any`[], `any`\> ; `error`: `SinonStub`<`any`[], `any`\> ; `fatal`: `SinonStub`<`any`[], `any`\> ; `info`: `SinonStub`<`any`[], `any`\> ; `trace`: `SinonStub`<`any`[], `any`\> ; `warn`: `SinonStub`<`any`[], `any`\>  } = logger.stubs; `removeConfig`: `SinonStub`<`any`[], `any`\> ; `removeSecret`: `SinonStub`<`any`[], `any`\> ; `removeState`: `SinonStub`<`any`[], `any`\> ; `setConfig`: `SinonStub`<`any`[], `any`\> ; `setSecret`: `SinonStub`<`any`[], `any`\> ; `setState`: `SinonStub`<`any`[], `any`\> ; `startActiveSpan`: `SinonStub`<`any`[], `any`\> ; `wrapInSpan`: `SinonStub`<`any`[], `any`\>  } |
| `stubs.getConfig` | `SinonStub`<`any`[], `any`\> |
| `stubs.getSecret` | `SinonStub`<`any`[], `any`\> |
| `stubs.getState` | `SinonStub`<`any`[], `any`\> |
...
[packages/core/src/mocks/getSubscriptionTransformContext.mock.ts:11](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/mocks/getSubscriptionTransformContext.mock.ts#L11)
...
[packages/core/src/CommandDefinitionBuilder/getCommandFunctionWithValidation.impl.ts:13](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/CommandDefinitionBuilder/getCommandFunctionWithValidation.impl.ts#L13)
...
[packages/core/src/DefaultEventBridge/getDefaultEventBridgeConfig.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/getDefaultEventBridgeConfig.impl.ts#L4)
...
[packages/core/src/core/DefaultLogger/getDefaultLogLevel.ts:3](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/DefaultLogger/getDefaultLogLevel.ts#L3)
...
| `cb` | (`message`: [`EBMessage`](purista_core.md#ebmessage)) => `Promise`<`undefined` \| `Omit`<[`CustomMessage`](purista_core.md#custommessage), ``"id"`` \| ``"instanceId"`` \| ``"timestamp"``\>\> |
...
[packages/core/src/DefaultEventBridge/getNewSubscriptionStorageEntry.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/getNewSubscriptionStorageEntry.impl.ts#L4)
...
[`SubscriptionFunction`](purista_core.md#subscriptionfunction)<`ServiceClassType`, `MessagePayloadType`, `MessageParamsType`, `MessagePayloadType`, `MessageParamsType`, `MessageResultType`\>

#### Defined in

[packages/core/src/SubscriptionDefinitionBuilder/getSubscriptionFunctionWithValidation.impl.ts:13](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/SubscriptionDefinitionBuilder/getSubscriptionFunctionWithValidation.impl.ts#L13)
...
[packages/core/src/DefaultConfigStore/initDefaultConfigStore.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultConfigStore/initDefaultConfigStore.impl.ts#L4)
...
[packages/core/src/DefaultSecretStore/initDefaultSecretStore.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultSecretStore/initDefaultSecretStore.impl.ts#L4)
...
[packages/core/src/DefaultStateStore/initDefaultStateStore.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultStateStore/initDefaultStateStore.impl.ts#L4)
...
[packages/core/src/core/DefaultLogger/initLogger.impl.ts:13](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/DefaultLogger/initLogger.impl.ts#L13)
...
[packages/core/src/core/types/isCustomMessage.impl.ts:10](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/isCustomMessage.impl.ts#L10)

___

### isHttpExposedServiceMeta

▸ **isHttpExposedServiceMeta**(`input?`): input is HttpExposedServiceMeta
...
input is HttpExposedServiceMeta

boolean - true if input is type of HttpExposedServiceMeta

#### Defined in

[packages/core/src/core/HttpServer/types/isHttpExposedServiceMeta.impl.ts:8](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/HttpServer/types/isHttpExposedServiceMeta.impl.ts#L8)
...
[packages/core/src/core/types/infoType/isInfoMessage.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/isInfoMessage.impl.ts#L4)
...
[packages/core/src/core/types/infoType/isInfoServiceFunctionAdded.impl.ts:5](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/core/types/infoType/isInfoServiceFunctionAdded.impl.ts#L5)
...
[packages/core/src/DefaultEventBridge/isMessageMatchingSubscription.impl.ts:4](https://github.com/sebastianwessel/purista/blob/dde9cc6/packages/core/src/DefaultEventBridge/isMessageMatchingSubscription.impl.ts#L4)

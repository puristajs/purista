import{_ as n,c as a,o as p,a9 as e}from"./chunks/framework.Bqk8xQPS.js";const f=JSON.parse('{"title":"Class: NatsConfigStore","description":"","frontmatter":{},"headers":[],"relativePath":"api/@purista/nats-config-store/classes/NatsConfigStore.md","filePath":"api/@purista/nats-config-store/classes/NatsConfigStore.md","lastUpdated":1774283249000}'),l={name:"api/@purista/nats-config-store/classes/NatsConfigStore.md"};function i(t,s,c,o,r,g){return p(),a("div",null,[...s[0]||(s[0]=[e(`<p><a href="./../../../README.html"><strong>PURISTA API</strong></a></p><hr><p><a href="./../../../packages.html">PURISTA API</a> / <a href="./../README.html">@purista/nats-config-store</a> / NatsConfigStore</p><h1 id="class-natsconfigstore" tabindex="-1">Class: NatsConfigStore <a class="header-anchor" href="#class-natsconfigstore" aria-label="Permalink to “Class: NatsConfigStore”">​</a></h1><p>Defined in: <a href="https://github.com/puristajs/purista/blob/master/packages/nats-config-store/src/NatsConfigStore.impl.ts#L31" target="_blank" rel="noreferrer">nats-config-store/src/NatsConfigStore.impl.ts:31</a></p><p>A config store for using NATS (with JetStream) as storage. JetStream must be enabled at the NATS broker.</p><h2 id="example" tabindex="-1">Example <a class="header-anchor" href="#example" aria-label="Permalink to “Example”">​</a></h2><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">*</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> \`\`\`typescript</span></span>

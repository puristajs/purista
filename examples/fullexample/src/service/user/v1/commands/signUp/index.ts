...
import { EventName, UserFunction } from '../../../../../types'
...
export const userSignUpBuilder = UserServiceBuilder.getFunctionBuilder(
  ...
  .setBeforeGuardHook(async function (_context, payload, _parameter) {
  ...
  .setAfterGuardHook(async function (_context, _payload, _parameter) {
  ...
  .transformInput(transformInputSchema, transformParameterSchema, async function (_context, payload, parameter) {
  ...
  .transformOutput(transformOutputSchema, async function (_context, payload, _parameter) {
